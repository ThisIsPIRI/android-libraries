...
/**Shows the string specified by message parameter in {@link DecisionDialogFragment#show} and notifies the {@code Activity} if the user agreed or not through {@code DialogListener.giveResult()}.*/
